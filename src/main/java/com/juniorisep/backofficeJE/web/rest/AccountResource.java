...
import com.juniorisep.backofficeJE.service.MailService;
import com.juniorisep.backofficeJE.service.UserService;
import com.juniorisep.backofficeJE.service.dto.PasswordChangeDTO;
import com.juniorisep.backofficeJE.service.dto.UserDTO;
import com.juniorisep.backofficeJE.service.mapper.UserMapper;
import com.juniorisep.backofficeJE.service.view.UserView;
import com.juniorisep.backofficeJE.security.SecurityUtils;
import com.juniorisep.backofficeJE.service.DeviceService;
import com.juniorisep.backofficeJE.web.rest.errors.EmailAlreadyUsedException;
import com.juniorisep.backofficeJE.web.rest.errors.InvalidPasswordException;
import com.juniorisep.backofficeJE.web.rest.errors.LoginAlreadyUsedException;
import com.juniorisep.backofficeJE.web.rest.errors.*;
import com.juniorisep.backofficeJE.web.rest.vm.KeyAndPasswordVM;
import com.juniorisep.backofficeJE.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public UserView getAccount(@RequestParam(value = "deviceToken", required = false) String deviceToken,
        ...
        if (Objects.nonNull(language) && !user.getLangKey().equals(language) && Constants.AVAILABLE_LANGUAGES.contains(language)){
