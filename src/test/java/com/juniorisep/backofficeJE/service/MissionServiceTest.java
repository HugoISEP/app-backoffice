...
import com.juniorisep.backofficeJE.domain.*;
...
public class MissionServiceTest {
    ...
    public void hasAuthorizationGetMissionByIdSuccess(){
        ...
        Assert.assertEquals(missionDTO, missionMapper.asDTO(mission));
    ...
    public void createMissionSuccess(){
        ...
        Assert.assertEquals(user.getCompany(), missionDTOSaved.getCompany());
    }
